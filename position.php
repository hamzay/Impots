...
<ol class="breadcrumb" style="margin: 10px 0px ! important;">
    <li class="breadcrumb-item"><a href="Home.php">Accueil</a><i class="fa fa-angle-right"></i>Parametrage<i class="fa fa-angle-right"></i>Profession</li>
</ol>
        ...
        <h2>Ajouter Profession</h2>
          	<div class="col-md-3 control-label">
            	<label class="control-label">Profession</label>
              	...
              	<input type="text" name="position" required="" value="<?php echo $name; ?>"  placeholder="Profession" class="form-control" style="width: 250px; height: 35px; float: right;">
              	</div>
            </div>
            	<div class="clearfix"> </div>
        </div>
            <div class="col-md-12 form-group">
              <button type="submit" name="positionl" class="btn btn-primary">Ajouter</button>
