...
<ol class="breadcrumb" style="margin: 10px 0px ! important;">
    <li class="breadcrumb-item"><a href="Home.php">Accueil</a><i class="fa fa-angle-right"></i>Parametrage<i class="fa fa-angle-right"></i>Pays</li>
</ol>
  ...
  <!---->
        ...
        <h2>Ajouter pays</h2>
            ...
            <div class="col-md-12 form-group">
              <button type="submit" name="countryy" class="btn btn-primary">Ajouter</button>
    ...
    <div style="height: 396px;">
          <div class="w3l-table-info">
            ...
            <form method="GET" action="#">
              ...
              <input style="float: right;" placeholder="Rechercher..." type="search-box" name="searccountry" value="<?php echo(isset($_GET['searccountry']))?$_GET['searccountry']:"";?>"><br>
            </form>
              <table id="table">
            <thead>
              <tr>
