            ...
            <div class="clearfix"> </div>
          	...
          	<div class="col-md-3 control-label">
            	<label class="control-label">Adresse</label>
              	...
              	<input type="text" name="city" placeholder="Nom adresse" value="<?php echo $name; ?>" required="" class="form-control" style="width: 250px; height: 35px;">
              	</div>
            </div>
            	<div class="clearfix"> </div>
        </div>
            <div class="col-md-12 form-group">
              <button type="submit" name="cityy" class="btn btn-primary">Ajouter</button>
 		...
 		<div style="height: 396px;">
					<div class="w3l-table-info" >
					  ...
					  <form method="GET" action="#">
					  	...
					  	<input style="float: right;" placeholder="Rechercher" type="search-box" name="searccity" value="<?php echo(isset($_GET['searccity']))?$_GET['searccity']:"";?>"><br>
					  </form> 
					    <table id="table">
						<thead>
						  <tr>
