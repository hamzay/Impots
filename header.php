	   ...
	   <div class="mother-grid-inner">
               <!--header start here-->
				<div class="header-main">
					<div style="padding: 0em; margin-right: 0%; width: 60%;" class="logo-w3-agile">
						<h1><a href="user/home.php">Service Impots<h5>Gestion des patentes et vignettes</h5></a></h1>
					</div>
						<div class="profile_details w3l" style="float: right; width: 19%;">		
								<ul>
									<li class="dropdown profile_details_drop">
										...
										<ul class="dropdown-menu drp-mnu">
											...
											<li> <a href="controller/logout.php"><i class="fa fa-sign-out"></i> Deconnexion</a> </li>
										</ul>
									</li>
								</ul>
							</div>
