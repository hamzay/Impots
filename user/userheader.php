            ...
            <div class="line">
               ...
               <div class="top-nav s-12 l-3 right">
                  <div class="employee-name" style="margin-top: 13%;">
                     <a style="color: white;">Utilisateur <font color="#808B96">:</font> <?php echo ucfirst($_SESSION['User']['nom']); ?></a> |
                     <a href="../controller/logout.php" style="text-align: right;"> Deconnexion </a>
                  </div>
