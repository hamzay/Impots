...
<ol class="breadcrumb" style="margin: 10px 0px ! important;">
    <li class="breadcrumb-item"><a href="Home.php">Accueil</a><i class="fa fa-angle-right"></i>Parametrage<i class="fa fa-angle-right"></i>Ville</li>
</ol>
        	...
        	<div class="col-md-3 control-label">
          	...
          	<div class="col-md-3 control-label">
            	<label class="control-label">Ville</label>
              	...
              	<input type="text" name="state" required="" value="<?php echo $name; ?>" placeholder="Nom ville" class="form-control" style="width: 250px; height: 35px; float: right;">
              	</div>
            </div>
            	<div class="clearfix"> </div>
        </div>
            <div class="col-md-12 form-group">
              <button type="submit" name="addstates" class="btn btn-primary">Ajouter</button>
 		...
 		<div style="height: 396px;">
					<div class="w3l-table-info">
					  ...
					  <form method="GET" action="#">
					  	...
					  	<input style="float: right;" placeholder="Rechercher..." type="search-box" name="searcstate" value="<?php echo(isset($_GET['searcstate']))?$_GET['searcstate']:"";?>"><br>
					  </form>
					    <table id="table">
						<thead>
						  <tr>
